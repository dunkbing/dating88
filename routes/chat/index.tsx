...
export default function ({ url, data }: PageProps<{ rooms: RoomView[] }>) {
  return (
    <>
      <Head>
        <title>Chat</title>
      ...
      <div class="flex justify-center items-center h-screen text-gray-600">
        <div>
          <div class="mb-16 mx-8 text-center">
            <img class="h-24 mx-auto mb-6" src="/logo.png" alt="Logo" />
            <span class="block text-3xl font-bold text-black mb-3">Chat</span>
          ...
          {data
            ? (
              <ul
                role="list"
                class="max-h-[21.375rem] mx-2 md:mx-0 overflow-y-scroll space-y-4"
              >
                <li>
                  <a
                    href="/new"
                    class="flex justify-center items-center bg-white rounded-full h-16 border-2 border-gray-300 transition-colors hover:(bg-green-100 border-green-400) group"
                  >
                  ...
                  return (
                    <li key={room.roomId}>
                      <a
                        ...
                        class="grid grid-cols-3 items-center bg-white rounded-full h-16 border-2 border-gray-300 transition-colors hover:(bg-gray-100 border-gray-400) group"
                      >
                        <div
